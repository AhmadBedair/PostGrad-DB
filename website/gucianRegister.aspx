<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gucianRegister.aspx.cs" Inherits="GucianPostGradSystem.gucianRegister" %>
...
<body style="height: 905px">
    <form id="form1" runat="server">
        ...
        <p>
            <asp:Label ID="Label7" runat="server" Text="Under Grad ID"></asp:Label>
        </p>
        
        <asp:TextBox ID="undergradID" runat="server"></asp:TextBox>
